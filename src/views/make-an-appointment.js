...
const MakeAnAppointment = (props) => {
  return (
    <div className="make-an-appointment-container">
      <Helmet>
        <title>Make-an-appointment - WD50_MP2</title>
        <meta property="og:title" content="Make-an-appointment - WD50_MP2" />
        <meta
          property="og:image"
      ...
      <div className="make-an-appointment-container1">
        <div className="make-an-appointment-div">
          <DangerousHTML
            html={`<!DOCTYPE html>
<html>
<head>
