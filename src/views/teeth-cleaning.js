...
const TeethCleaning = (props) => {
  return (
    <div className="teeth-cleaning-container">
      <Helmet>
        <title>Teeth-Cleaning - WD50_MP2</title>
        <meta property="og:title" content="Teeth-Cleaning - WD50_MP2" />
        <meta
          property="og:image"
      ...
      <div className="teeth-cleaning-container1">
        <div className="teeth-cleaning-div">
          <DangerousHTML
            html={`<!DOCTYPE html>
<html>
<head>
